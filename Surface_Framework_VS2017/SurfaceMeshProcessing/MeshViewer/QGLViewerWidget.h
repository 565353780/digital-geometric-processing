...
public:
	...
	enum DrawMode{ POINTS, WIREFRAME, HIDDENLINES, FLATLINES, FLAT, SMOOTH, SHORTESET_PATH, DISCRETE_CURVATURE, MESH_DENOISING, MESH_PARAMETERIZATION_1, MESH_PARAMETERIZATION_2, ARAP_SURFACE_MODELING, BARYCENTRIC_COORDINATES, MESH_INTERPOLATION, MESH_SIMPLIFICATION, CROSS_FIELDS, REMESHING, OPTIMAL_DELAUNAY_TRIANGULATION, LLOYD_ITERATION_ALGORITHM, GEOMETRIC_OPTIMIZATION };
