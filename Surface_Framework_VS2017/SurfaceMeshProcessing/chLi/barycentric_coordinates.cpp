...
double Barycentric_Coordinates::get_Dist_2_of_Points(Mesh::Point point_1, Mesh::Point point_2)
{
...
double Barycentric_Coordinates::get_Dist_of_Points(Mesh::Point point_1, Mesh::Point point_2)
{
	return sqrt(get_Dist_2_of_Points(point_1, point_2));
}

double Barycentric_Coordinates::get_Norm_of_Point(Mesh::Point point)
{
...
double Barycentric_Coordinates::get_Norm_of_Vector(std::vector<double> x)
{
...
bool Barycentric_Coordinates::is_In_Set(std::vector<int> set, int data)
{
...
double Barycentric_Coordinates::get_Radian_of_Three_Points(Mesh::Point point_1, Mesh::Point point_mid, Mesh::Point point_2)
{
...
double Barycentric_Coordinates::get_Cot_of_Three_Points(Mesh::Point point_1, Mesh::Point point_mid, Mesh::Point point_2)
{
...
double Barycentric_Coordinates::get_Area_of_Three_Points(Mesh::Point point_1, Mesh::Point point_2, Mesh::Point point_3)
{
	std::vector<double> x_1;
	std::vector<double> x_2;
...
double Barycentric_Coordinates::get_Area_of_Four_Points(Mesh::Point point_1, Mesh::Point point_2, Mesh::Point point_3, Mesh::Point point_4)
{
	return get_Area_of_Three_Points(point_1, point_2, point_3) + get_Area_of_Three_Points(point_1, point_3, point_4);
}

double Barycentric_Coordinates::get_Area_of_Face_by_Face_Idx(Mesh& mesh, int fh_idx)
{
...
std::vector<double> Barycentric_Coordinates::get_Norm_Vector_of_Triangle_by_Three_Points(Mesh::Point point_1, Mesh::Point point_2, Mesh::Point point_3)
{
...
std::vector<double> Barycentric_Coordinates::get_Norm_Vector_of_Triangle_by_Face_Idx(Mesh& mesh, int fh_idx)
{
	std::vector<int> vh_idx_set;
...
std::vector<double> Barycentric_Coordinates::get_Center_of_Triangle_by_Face_Idx(Mesh& mesh, int fh_idx)
{
	std::vector<int> vh_idx_set;
...
std::vector<int> Barycentric_Coordinates::get_Neighboor_Face_Idx_Set(Mesh& mesh, int fh_idx)
{
...
std::vector<double> Barycentric_Coordinates::get_Local_Average_Area_Set_of_VH(Mesh& mesh)
{
...
std::vector<std::vector<double>> Barycentric_Coordinates::get_Cot_Weight_Set(Mesh& mesh)
{
...
std::vector<std::vector<double>> Barycentric_Coordinates::Update_VH_Position(Mesh& mesh, std::vector<int> target_vh_idx, std::vector<std::vector<double>> target_pose, std::vector<int> fixed_vh_idx)
{
	...
	std::cout << "--------average fixed pose : " << std::endl;
	for (int i = 0; i < 3; ++i)
	{
		std::cout << avg_fixed_pose[i] << ",";
	}
	std::cout << std::endl;
	...
	for (int i = 0; i < mesh.n_vertices(); ++i)
	{
		...
		for (int j = 0; j < cot_weight_set[i].size(); ++j)
		{
			std::cout << "ok 2-1-1 !!!!!!!!!!!!!" << std::endl;
			...
			std::cout << "ok 2-1-2 !!!!!!!!!!!!!" << std::endl;

			A(i, i) -= local_average_area_set[vh_neighboor_vh_idx_set[j]] * cot_weight_set[vh_neighboor_vh_idx_set[j]][current_vh_neighboor_idx];

			std::cout << "ok 2-1-3 !!!!!!!!!!!!!" << std::endl;

			A(i, j) -= local_average_area_set[i] * cot_weight_set[i][j];

			std::cout << "ok 2-1-4 !!!!!!!!!!!!!" << std::endl;

			A(i, j) += local_average_area_set[vh_neighboor_vh_idx_set[j]] * cot_weight_set[vh_neighboor_vh_idx_set[j]][current_vh_neighboor_idx];

			std::cout << "ok 2-1-5 !!!!!!!!!!!!!" << std::endl;
