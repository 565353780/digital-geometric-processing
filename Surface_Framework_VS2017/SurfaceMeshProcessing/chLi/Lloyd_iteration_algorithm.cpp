#include "Lloyd_iteration_algorithm.h"

Lloyd_Iteration_Algorithm::Lloyd_Iteration_Algorithm()
{
...
double Lloyd_Iteration_Algorithm::get_Dist_2_of_Points(Mesh::Point point_1, Mesh::Point point_2)
{
...
double Lloyd_Iteration_Algorithm::get_Dist_of_Points(Mesh::Point point_1, Mesh::Point point_2)
{
	return sqrt(get_Dist_2_of_Points(point_1, point_2));
}

double Lloyd_Iteration_Algorithm::get_Dist_2_of_Vector(VectorXd& vector_1, VectorXd& vector_2)
{
	double dist_2 = 0;
...
double Lloyd_Iteration_Algorithm::get_Dist_2_of_Vector(RowVectorXd& vector_1, RowVectorXd& vector_2)
{
	double dist_2 = 0;
...
double Lloyd_Iteration_Algorithm::get_Dist_of_Vector(VectorXd& vector_1, VectorXd& vector_2)
{
	return sqrt(get_Dist_2_of_Vector(vector_1, vector_2));
}

double Lloyd_Iteration_Algorithm::get_Dist_of_Vector(RowVectorXd& vector_1, RowVectorXd& vector_2)
{
	return sqrt(get_Dist_2_of_Vector(vector_1, vector_2));
}

double Lloyd_Iteration_Algorithm::get_Norm_of_Point(Mesh::Point point)
{
...
double Lloyd_Iteration_Algorithm::get_Norm_of_Vector(std::vector<double> x)
{
...
bool Lloyd_Iteration_Algorithm::is_In_Set(std::vector<int> set, int data)
{
...
double Lloyd_Iteration_Algorithm::get_Radian_of_Three_Points(Mesh::Point point_1, Mesh::Point point_mid, Mesh::Point point_2)
{
...
double Lloyd_Iteration_Algorithm::get_Cot_of_Three_Points(Mesh::Point point_1, Mesh::Point point_mid, Mesh::Point point_2)
{
...
double Lloyd_Iteration_Algorithm::get_Area_of_Three_Points(Mesh::Point point_1, Mesh::Point point_2, Mesh::Point point_3)
{
	std::vector<double> x_1;
	std::vector<double> x_2;
...
double Lloyd_Iteration_Algorithm::get_Area_of_Four_Points(Mesh::Point point_1, Mesh::Point point_2, Mesh::Point point_3, Mesh::Point point_4)
{
	return get_Area_of_Three_Points(point_1, point_2, point_3) + get_Area_of_Three_Points(point_1, point_3, point_4);
}

double Lloyd_Iteration_Algorithm::get_Area_of_Face_by_Face_Idx(Mesh& mesh, int fh_idx)
{
...
std::vector<double> Lloyd_Iteration_Algorithm::get_Norm_Vector_of_Triangle_by_Three_Points(Mesh::Point point_1, Mesh::Point point_2, Mesh::Point point_3)
{
...
std::vector<double> Lloyd_Iteration_Algorithm::get_Norm_Vector_of_Triangle_by_Face_Idx(Mesh& mesh, int fh_idx)
{
	std::vector<int> vh_idx_set;
...
std::vector<double> Lloyd_Iteration_Algorithm::get_Center_of_Triangle_by_Face_Idx(Mesh& mesh, int fh_idx)
{
	std::vector<int> vh_idx_set;
...
std::vector<int> Lloyd_Iteration_Algorithm::get_Neighboor_Face_Idx_Set(Mesh& mesh, int fh_idx)
{
...
std::vector<std::vector<int>> Lloyd_Iteration_Algorithm::get_FVH_Idx_Set(Mesh& mesh)
{
...
std::vector<std::vector<int>> Lloyd_Iteration_Algorithm::get_VFH_Idx_Set(Mesh& mesh)
{
...
std::vector<double> Lloyd_Iteration_Algorithm::get_Face_Area_Set(Mesh& mesh)
{
...
std::vector<double> Lloyd_Iteration_Algorithm::get_Local_Average_Area_Set_of_VH(Mesh& mesh)
{
...
Matrix<double, 1, 3> Lloyd_Iteration_Algorithm::get_Vector3d_from_VH(Mesh& mesh, int vh_idx)
{
	Matrix<double, 1, 3> v;
...
MatrixXd Lloyd_Iteration_Algorithm::get_Circum_Circle_Center(Mesh& mesh)
{
...
bool Lloyd_Iteration_Algorithm::update_Delaunay_Triangulation(Mesh& mesh)
{
...
bool Lloyd_Iteration_Algorithm::update_Vertex_Position_By_Circum_Center(Mesh& mesh)
{
...
bool Lloyd_Iteration_Algorithm::get_Lloyd_Iteration_Algorithm_Result(Mesh& mesh, int solve_num)
{
	if (solve_num < 0)
	{
		return true;
